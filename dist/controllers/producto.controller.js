...
exports.createProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newProducto, results;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newProducto = typeorm_1.getRepository(Producto_1.Producto).create(req.body);
                return [4 /*yield*/, typeorm_1.getRepository(Producto_1.Producto).save(newProducto)];
            case 1:
                results = _a.sent();
